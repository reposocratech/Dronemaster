        ...
        <section className='allCoursesContainer p-0 px-sm-5'>
            ...
            {course?.length === 0 && <>
                <div className="categoryContainer">
                    <h2 className="categoryTitle text-center text-md-start">No existe resultado de búsqueda</h2>
            ...
            {course?.length > 0 &&
                <div className='allCoursesContainer p-0 px-sm-5'>
                    <div className="categoryContainer">
                        <h2 className="categoryTitle text-center text-md-start">Resultado de búsqueda</h2>
                        <div className="courseCardContainerWrapper">
                            {counter !== 0 ?
