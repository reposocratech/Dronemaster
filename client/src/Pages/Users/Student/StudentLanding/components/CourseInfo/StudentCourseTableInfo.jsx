                ...
                {courseMaterial.unit_tittle.map((elem) => {
                    return (
                        <table className="coursesTable">
                            <thead>
                                <tr key={elem.unit_id}>
                                    <th className="textReduce text-warning w-75">{elem.unit_tittle}</th>
                                ...
                                {courseMaterial.lesson_title.map((elem) => {
                                    return (
                                        <tr key={elem.lesson_id} >
                                            <td className="textReduce text-start w-75">{elem.lesson_title}</td>
                                            <td><AiFillEye /></td>
                                            <td className=" text-center"><AiFillFile /></td>
                                        </tr>
                                    )
