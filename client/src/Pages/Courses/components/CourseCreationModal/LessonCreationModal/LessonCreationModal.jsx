...
export const LessonCreationModal = ({ setShowLessonCreationModal, showLessonCreationModal, course_id, resEffect, setResEffect, unitId }) => {
    console.log(unitId);
    const {
        register,
        handleSubmit,
    ...
    const onSubmit = (data) => {
        ...
        axios
            .post(`http://localhost:4000/admin/createLesson/${course_id}/${unitId}`, data)
            .then((res) => {
                setShowLessonCreationModal(false);
                reset()
                ...
                <Modal.Body className="modalBodyLesson">
                    ...
                    <div className="d-flex flex-column align-items-start gap-1 inputUrl">
                        ...
                        <input
                            ...
                            id="lesson_url_video"
                        />
                        <span className="errorMessage">{errors.lesson_url_video?.message}</span>
                    </div>
                </Modal.Body>
